...
public class BarChartAttrs extends BaseChartAttrs{
    ...
    public boolean enableAverageRectF;

    public int barChartSegment;//绘制血氧、心率等分段的 BarChart;  1 表示分段， 0表示不分段。

    public final static int SEGMENT_Y = 1;
    public final static int SEGMENT_N = 0;

    public int specialStrokeColor;//默认不用设置 stroke与bar颜色一致
}
