package com.yxc.customerchart.service;
...
import com.yxc.customerchart.event.ProgressUpdateEvent;
import com.yxc.customerchart.inject.component.DaggerServiceComponent;
import com.yxc.customerchart.inject.component.ServiceComponent;
import com.yxc.customerchart.inject.modules.ServiceModule;
import com.yxc.customerchart.rxutils.FileUtils;
        ...
        subscription = downLoadApi.getDownApk()
                ...
                .flatMap(new Func1<ResponseBody, Observable<Boolean>>() {
                    ...
                    public Observable<Boolean> call(ResponseBody responseBody) {
                        Boolean writtenToDisk = FileUtils.writeResponseBodyToDisk(responseBody, getApplicationContext());
