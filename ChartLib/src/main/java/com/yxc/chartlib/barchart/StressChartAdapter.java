...
import com.xiaomi.fitness.chart.entrys.StressEntry;
 ...
 * @date 2019-05-15
 */
public class StressChartAdapter extends BaseBarChartAdapter<SegmentBarEntry, VarietyMaxYAxis> {

    public StressChartAdapter(Context context, List<SegmentBarEntry> entries,
