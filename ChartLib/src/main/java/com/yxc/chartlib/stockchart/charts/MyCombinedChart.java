package com.yxc.chartlib.stockchart.charts;

import static com.yxc.mylibrary.TimeDateUtil.secToDate;
import static com.yxc.mylibrary.TimeDateUtil.secToTime;
...
import com.yxc.chartlib.stockchart.renderer.MyCombinedChartRenderer;
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (this.timeType == TimeType.TIME_HOUR) {
                date = secToTime(kLineData.getKLineDatas().get((int) e.getX()).getDateMills());
            } else {
                date = secToDate(kLineData.getKLineDatas().get((int) e.getX()).getDateMills());
            }
