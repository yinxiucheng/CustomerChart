package com.yxc.chartlib.stockchart;

import static com.yxc.mylibrary.TimeDateUtil.secToDate;
...
import com.yxc.chartlib.stockchart.charts.CandleCombinedChart;
import com.yxc.chartlib.stockchart.charts.CoupleChartGestureListener;
import com.yxc.chartlib.stockchart.charts.MyCombinedChart;
import com.yxc.chartlib.stockchart.datamanage.KLineDataManage;
import com.yxc.chartlib.stockchart.enums.TimeType;
import com.yxc.chartlib.stockchart.markviews.BarBottomMarkerView;
import com.yxc.chartlib.stockchart.markviews.KRightMarkerView;
import com.yxc.chartlib.stockchart.markviews.LeftMarkerView;
import com.yxc.chartlib.stockchart.valuefomatter.VolFormatter;
import com.yxc.chartlib.util.NumberUtils;
...
public class KLineChart extends BaseChart {
    ...
    public void initChart(boolean landscape) {
        ...
        axisLeftK.enableGridDashedLine(DisplayUtil.dip2px(4), DisplayUtil.dip2px(3), 0);
...
//        axisLeftK.setValueLineInside(true); //todo 暂且注释掉。
...
//        candleDataSet.setPrecision(precision);
        ...
        if (isFirst) {
            ...
            if (landscape) {
                ...
                left_right = DisplayUtil.dip2px(pricewidth > volwidth ? pricewidth : volwidth);
                candleChart.setViewPortOffsets(left_right, DisplayUtil.dip2px(15), DisplayUtil.dip2px(5), 0);
                barChart.setViewPortOffsets(left_right, DisplayUtil.dip2px(15), DisplayUtil.dip2px(5), DisplayUtil.dip2px(16));
            } else {
                left_right = DisplayUtil.dip2px(5);
                candleChart.setViewPortOffsets(left_right, DisplayUtil.dip2px(15), DisplayUtil.dip2px(5), 0);
                barChart.setViewPortOffsets(left_right, DisplayUtil.dip2px(15), DisplayUtil.dip2px(5), DisplayUtil.dip2px(16));
            }
    ...
    public void dynamicsAddOne(KLineDataManage kLineData) {
        ...
        kLineData.getxVals().add(secToDate(kLineData.getKLineDatas().get(i).getDateMills()));
