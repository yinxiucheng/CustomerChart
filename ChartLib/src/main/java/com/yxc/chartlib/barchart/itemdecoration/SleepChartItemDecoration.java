...
import com.yxc.fitness.chart.render.SleepChartRender;
 ...
 */
public class SleepChartItemDecoration extends BaseChartItemDecoration<SleepChartAttrs, YAxis> {

    private SleepChartRender mBarChartRender;

    private ValueFormatter mBarChartValueFormatter;
    private ValueFormatter mHighLightValueFormatter;

    public SleepChartItemDecoration(YAxis yAxis, XAxis xAxis, SleepChartAttrs barChartAttrs) {
        ...
        this.mBarChartRender = new SleepChartRender(mBarChartAttrs, mBarChartValueFormatter);
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        mBarChartRender.drawHighLight(canvas, parent);
        Log.d("MPChart", "BarChart Render click draw off time:" + System.currentTimeMillis());
        mBarChartRender.drawSleepChart(canvas, parent);//draw BarChart
