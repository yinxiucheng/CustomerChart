...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private final RecyclerView.OnScrollListener mScrollListener =
            new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    Log.d("Scroller", " SnapHelper onScrollStateChanged !!");
    ...
    void snapToTargetExistingView() {
        ...
        DistanceCompare distanceCompare = findSnapView(layoutManager);
        if (distanceCompare == null || distanceCompare.snapView == null) {
            return;
        }
        int[] snapDistance = calculateDistanceToFinalSnap(layoutManager, distanceCompare);
    ...
    @Nullable
    @Deprecated
    protected MyLinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        if (!(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider)) {
            return null;
        }
        return new MyLinearSmoothScroller(mRecyclerView.getContext()) {
            @Override
            protected void onTargetFound(DistanceCompare distanceCompare, RecyclerView.State state, Action action) {
                ...
                int[] snapDistances = calculateDistanceToFinalSnap(mRecyclerView.getLayoutManager(), distanceCompare);
     ...
     * @param layoutManager the {@link RecyclerView.LayoutManager} associated with the attached
     *                      {@link RecyclerView}
     * @param distanceCompare the target view that is chosen as the view to snap
     *
    ...
    public abstract int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager,
                                                       @NonNull DistanceCompare distanceCompare);
    ...
    @SuppressWarnings("WeakerAccess")
    @Nullable
    public abstract DistanceCompare findSnapView(RecyclerView.LayoutManager layoutManager);
