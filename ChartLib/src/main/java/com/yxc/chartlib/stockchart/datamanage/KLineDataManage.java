package com.yxc.chartlib.stockchart.datamanage;
...
import com.yxc.chartlib.stockchart.model.KLineDataModel;
import com.yxc.chartlib.stockchart.model.entitys.BOLLEntity;
import com.yxc.chartlib.stockchart.model.entitys.KDJEntity;
import com.yxc.chartlib.stockchart.model.entitys.MACDEntity;
import com.yxc.chartlib.stockchart.model.entitys.RSIEntity;
        ...
        if (object != null) {
            ...
            if (data != null) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    xVal.add(secToDate(getKLineDatas().get(i).getDateMills()));
